...
TASK_FILES="docs/process/state/tasks.json Jay/memory/working-context.md Jay/state/OPEN_TASKS.md docs/process/task-queue.md docs/process/live-status.md docs/process/projects.md"
