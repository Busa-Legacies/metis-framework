  ...
  return (
    <div data-testid="usage-mode" className="flex h-full w-full flex-col overflow-hidden">
      <div className="flex items-center gap-2 border-b border-[var(--line)] bg-black/20 px-3 py-2 text-[15px] md:text-[12px]">
        ...
        <span className="text-[17px] md:text-[13px] font-black uppercase tracking-[0.18em] text-cyan-100">AI Capacity</span>
      ...
      {res && !res.ok ? (
        ...
        <div className="grid flex-1 grid-cols-1 gap-4 overflow-y-auto p-4 md:gap-3 md:p-3 sm:grid-cols-2 xl:grid-cols-3">
          ...
          <StatusCard title="Claude" icon={<Sparkles size={12} />}>
            ...
            <div className="mt-1 flex justify-between text-[13px] md:text-[11px] text-[var(--muted)]">
            ...
            {!rl?.claude && <span className="text-[15px] md:text-[12px] text-[var(--muted)]">no Claude usage data</span>}
          </StatusCard>
          ...
          <StatusCard title="Codex" icon={<Terminal size={12} />}>
            ...
            {!rl?.codex && <span className="text-[15px] md:text-[12px] text-[var(--muted)]">no Codex usage data</span>}
          </StatusCard>
          ...
          <StatusCard title="Local · Ollama" icon={<Server size={12} />} severity={data.ollama.running ? 'ok' : 'warn'}>
            ...
            <ul className="flex flex-col gap-0.5 text-[13px] md:text-[11px] text-[var(--muted)]">
