...
export default function AgentTerminal({ agentId }: Props) {
  ...
  useEffect(() => {
    ...
    return () => {
      ...
      ro.disconnect()
      onData.dispose()
      // Detach handlers so a mid-connect teardown doesn't write to a disposed term.
      ws.onmessage = null
      ws.onclose = null
      // Closing a still-CONNECTING socket logs a console warning; defer the close to onopen instead.
